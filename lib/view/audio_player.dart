...
class dusicPage extends StatefulWidget {
  const dusicPage({Key? key}) : super(key: key);

  @override
  State<dusicPage> createState() => _dusicPageState();
}

class _dusicPageState extends State<dusicPage> {
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/we.jpeg"),
                fit: BoxFit.cover,
              ),
            ),
